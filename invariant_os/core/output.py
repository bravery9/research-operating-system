...
def write_audit_outputs(result: AuditResult, output_dir: Path) -> tuple[Path, Path, Path, Path]:
    """Write stable JSON, Markdown, graph, and HTML audit artifacts."""
    ...
    return json_path, markdown_path, graph_path, html_path
